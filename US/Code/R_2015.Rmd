...
------
Overall we got 248 valid review reports for year 2015, average score is 2.859, going down 1% from year 2014. Most of reviews have score 3 - Commendable. In the regression model: Gender, Marital Status, Vesting Service, Active Status, and Education Level show significant effects on review scores; Age and Children do not show clear patterns.
...
If we summarized review scores by department: Operations is the largest department in the analysis, and as the review scores increase, the number of employees from Operations goes down;  on the other hand, Quality/Applications and Sales employees tend to have higher scores. And we do not have Research, Marketing, and Finance departments in this analysis.
...
Level 0 – High School or Others is the largest group in the analysis. In the second plot, we can see a clear pattern that as education level goes up, the review scores go up too. If we look into the education by departments plots (third and fourth plots): Operations has relative lower education level, while Quality/Applications and Sales have relative higher education level. 
...
In the analysis, we have female rate 25.8%, and females tend to have higher review scores (Wilcoxon level test shows statistically significant: p-value 3.499e-06). When looking into gender by department plots (last two plots): Quality/Applications, Administration, and Regulatory have more female percentage then male; while Operations has more male.
...
In the analysis, we have marriage rate 60.9%, and married employees tend to have higher review scores (Wilcoxon level test shows statistically significant: p-value 0.0001618).
